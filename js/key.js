...
var Key = {
	...
	_changed: {},
	// Whether this key was recently changed
	_timeheld: {},
	// How many steps this key has been pressed
...
/*var ar=new Array(33,34,35,36,37,38,39,40);
	...
	timestep: function () {
		// Set changed=false for every key. Should be called repeatedly as time passes
		...
		for (var key in Key._key) {
			...
			if (Key._key[key] == true) Key._timeheld[key]++;
		}
	},
	register: function (target_element) {
		...
		$(target_element).mousemove(function (e) {
	...
	mouseup: function (evt) {
		...
		else if (evt.which == 2) return Key.keyup({
			keyCode: MOUSE_MIDDLE
		});
		else if (evt.which == 3) return Key.keyup({
			keyCode: MOUSE_RIGHT
		});
	},
